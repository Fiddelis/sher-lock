...
CREATE TABLE IF NOT EXISTS product (
	...
	FOREIGN KEY (drawer_locker_id) REFERENCES locker (id)
);
...
INSERT INTO product (client_id, drawer_id, drawer_locker_id, name, quantity, weight, dimension, estimated_date, address, available, pass_code) VALUES
(1, 1, 1, 'Livro', 1, 0.5, '20x20x10 cm', '2024-06-10', 'Rua A, 123', true, 'abc123'),
(1, 2, 1, 'Notebook', 1, 2.5, '40x30x5 cm', '2024-06-15', 'Rua A, 123', true, 'def456'),
(2, 3, 2, 'Câmera', 1, 1.0, '15x10x10 cm', '2024-06-20', 'Avenida B, 456', true, 'ghi789');